...
function Navbar() {
  ...
  return (
    <>
      {/* for space from left to right , for different devices also */}
      <div
            ...
            <div className="hidden md:block">
              <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M9.965 11.026a5 5 0 1 1 1.06-1.0612.755 2.754a.75.75 0 1 1-1.06 1.061-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z"
                    clipRule="evenodd"
                  />
                </svg>
              </label>
